...
export async function insertOutboundMessage({
  ...
  try {
    const r = await pool.query(`
      INSERT INTO messages
        (conversation_id, contact_id, provider_message_id, provider_reply_id, direction, message_type, body, media_url, status, raw_payload, sent_by, created_at, updated_at, reply_to_message_id, reply_to_provider_message_id)
      VALUES ($1,$2,$3,$4,'out',$5,$6,$7,$8,$9,$10,$11,$11,$12,$13)
      RETURNING *
    `, [
